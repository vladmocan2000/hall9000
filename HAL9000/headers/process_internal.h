...
typedef struct _PROCESS
{
    ...
    LOCK                            NumberOfUsermodeThreadsLock;

    _Guarded_by_(NumberOfUsermodeThreadsLock)
    QWORD                           NumberOfUsermodeThreads;

    LOCK                            UsermodeThreadListLock;

    _Guarded_by_(UsermodeThreadListLock)
    LIST_ENTRY                      HeadUsermodeThreadList;
